...
const MENU_ITEMS = [
  ...
  { icon: Shield, label: "Security", desc: "Password & 2FA settings" },
  { icon: Globe, label: "Language & Region", desc: "Language, currency, timezone" },
];
...
export default function Profile() {
  ...
  const [currentPlan] = useState<"free" | "pro">("free"); // toggle to "pro" to demo
