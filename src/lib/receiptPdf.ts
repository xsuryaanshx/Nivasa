...
export async function downloadReceiptPdf(p: any, landlordName: string = "Nivasa Landlord") {
  ...
  try {
    ...
    doc.text("NIVASA BY AMI GROUP", 16, 24);
  }
  ...
  doc.text("This receipt is a digitally generated document by Nivasa by Ami Group. Official proof of rent settlement.", 105, 275, { align: "center" });
...
export async function downloadInvoicePdf(invoice: any, tenant: any, room: any, landlordName: string = "Nivasa Landlord", upiId?: string) {
  ...
  doc.setFontSize(7.5);
  doc.setTextColor(148, 163, 184); // Slate 400
  doc.text("This invoice is an official rent invoice generated by Nivasa by Ami Group. Please pay before the due date.", 105, 275, { align: "center" });
