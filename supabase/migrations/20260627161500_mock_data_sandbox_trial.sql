...
-- 2. Create function to seed mock/sandbox data for a given user (Defined first so setup trigger can use it)
...
-- 3. Modify handle_new_user_setup function to default to a 7-day trial and auto-seed mock data
